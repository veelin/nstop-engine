...
@Component
public class HttpStartEventValidator extends ElementValidator {

    protected static final Logger LOGGER = LoggerFactory.getLogger(HttpStartEventValidator.class);
    /**
